...
import {Cookies} from 'react-cookie'; // Import the Cookies library
...
export default function Landing() {
  ...
  const logoutUser = async () => {
    try {
      ...
      const response = await axios.delete(`http://127.0.0.1:8000/delete_session/${session_id}/`);
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        <div className="mb-4">
          <button onClick={logoutUser} className="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full flex items-center">
